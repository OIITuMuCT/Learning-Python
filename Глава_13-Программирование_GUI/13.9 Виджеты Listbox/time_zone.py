...
class TimeZone:
    ...
    def __build_output_frame(self):
        ...
        # Создать переменную для хранения имени часового пояса.
        ...
        self.output_label = tkinter.Label(
            ...
            width=30, textvariable=self.__timezone 
        ) # width было 15, изменен чтобы помещалась вся надпись
