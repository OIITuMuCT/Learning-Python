...
class MyGUI:
    def __init__(self):
        ...
        self.__X1 = 60   # Левая верхняя координата х прямоугольника
        self.__Y1 = 20   # Левая верхняя координата y прямоугольника
        self.__X2 = 260  # Нижняя правая координата х прямоугольника
        self.__Y2 = 220  # Нижняя правая координата y прямоугольника
